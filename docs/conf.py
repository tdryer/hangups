...
exclude_patterns = [
    ...
    'proto.rst',  # manually included in protobuf.rst
]
...
latex_documents = [
  ('index', 'hangups.tex', 'hangups Documentation',
   'Tom Dryer', 'manual'),
]
...
man_pages = [
    ('index', 'hangups', 'hangups Documentation',
     ['Tom Dryer'], 1)
]
...
texinfo_documents = [
  ('index', 'hangups', 'hangups Documentation',
   'Tom Dryer', 'hangups', 'One line description of project.',
   'Miscellaneous'),
]
